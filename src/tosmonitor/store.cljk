(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Xero Limited, LEI
  254900UG5D8YST164N14) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms of Use\nBy accessing or using the Xero cloud accounting platform you agree to these Terms of Use. The Services are provided by Xero Limited for use by businesses, accountants, and bookkeepers to manage financial and business records online. These Terms are governed by the laws of New Zealand.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.xero.com/legal/terms/"
   :retrieved-at "2026-07-10T08:36:04Z"
